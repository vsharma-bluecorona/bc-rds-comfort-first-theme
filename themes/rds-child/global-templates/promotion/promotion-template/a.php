                                            ...
                                            <div class="row">
                                                ...
                                                if (have_posts()) :
                                                    ...
                                                    if(strtotime($date) >= strtotime(current_time('m/d/Y')) || $noexpiry == 1){
                                                       ...
                                                       <div class="<?php echo ($enable_sidebar === 'yes') ? 'col-lg-6 mb-lg-5 mb-4 pb-lg-3' : 'col-lg-4 mb-lg-5 mb-4'; ?> px-1 px-lg-1 px-xl-3">
                                                                <div class="h-coupan-100 color_primary_bg  border-radius-10 color_tertiary_bg p-3" style="background-color: <?php echo $colorCode; ?>;">
