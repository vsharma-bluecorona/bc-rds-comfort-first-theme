                                                        ...
                                                        <div class="<?php echo ($enable_sidebar === 'yes') ? 'col-lg-6 mb-lg-5 mb-4 pb-lg-3' : 'col-lg-4 mb-lg-5 mb-4'; ?>">
                                                            <div class="h-auto border-quaternary-dashed  p-lg-2 p-3">
                                                                <div class="coupon_name  color_primary_bg  h-100 py-4 p-4 px-lg-0 text-center" style="background-color: <?php echo $colorCode; ?>;">
                                                                    ...
                                                                    <h4 class="mb-0 pb-lg-3 pt-lg-0 py-3 coupon_title coupon_offer px-1 px-lg-0"><?php echo $title; ?></h4>
                                                                    <a data-bs-toggle="modal" data-bs-target="#request_coupon_form" onclick="couponButtonClick(this);" class="btn btn-primary mw-206">Request Service <i class="icon-chevron-right text_18 line_height_18 ms-2"></i></a>
                                                                    <span class="pt-lg-3 pt-2 d-block px-3 coupon_expiry"><?php if($noexpiry !=1){ echo 'Expires '.$date.'<br>';}?><span class="d-block coupon_disclaimer"><?php echo $footer_heading; ?></span></span>
                                                                </div>
                                                            </div>
                                                        </div>  
                                                        <?php 
                    ...
                    <div class="modal-content border-0 rounded-0 text-center">
                        ...
                        <div class="modal-body p-lg-4 p-2 w-100 my-auto mx-auto coupons">
                            <div class="border-dashed-7-secondary pt-lg-4 pb-lg-4 py-4 footer_form_A ui_kit_footer_form elementor-popupform">
                                <h3 class="px-lg-0 text_medium px-4"><?php echo $args['globals']['promotion']['popup_form_heading']; ?></h3>
