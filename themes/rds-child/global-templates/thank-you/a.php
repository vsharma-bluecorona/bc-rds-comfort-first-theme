                        ...
                        <div class="container px-lg-3 px-0">
                            <div class="row pb-lg-2 pt-lg-5 mx-0">
                                <div class="col-12 col-lg-12 order-lg-1 order-1 pt-lg-1">
                                    <div class="text-center thankyou-conten-color">
                                        <img src="<?php echo get_exist_image_url('thank-you','thank-you-graphic'); ?>" srcset="<?php echo get_exist_image_url('thank-you','thank-you-graphic'); ?> 1x, <?php echo get_exist_image_url('thank-you','thank-you-graphic@2x'); ?> 2x, <?php echo get_exist_image_url('thank-you','thank-you-graphic@3x'); ?> 3x" class="img-fluid mx-auto" <?php echo $alt ?>  width="540" height="163" >
                                            ...
                                            <p class="thankyou_page_content_color alt_color8 mb-4">
                                             ...
                                             <?php 
                                              ...
                                              <div class="text-center pt-2">
                                                  <span  onclick="scrollSmoothTo('thankyou_page_promotion')" class="next-service btn btn-primary mw-250" id="bc-thankyou"><?php echo $args['page_templates']['thankyou_page']['scroll_button_text'] ?> <i class="icon-circle-arrow-down2 ms-2 line_height_18"></i></span>
                                              </div>
                                          <?php } ?>
                                          </div>
                                    ...
                                    <div class="row align-items-center mx-auto py-lg-4" >
                                        ...
                                        <?php
                                            if ($get_rds_template_data_array['globals']['affiliation']['variation']) {
                                                get_template_part('global-templates/affiliation/thank-you/a', null, $get_rds_template_data_array);
                                            }
                                        ?>
                                    </div>
                                </div>
                    ...
                    <div class="container px-lg-3 pb-lg-5">
                        <div class="row align-items-center">
                            <div class="<?php echo ($args['page_templates']['thankyou_page']['variation'] == 'b') ? 'order-2 mt-lg-0 mt-5' : ''; ?> col-lg-6 px-4 px-lg-3 text-center text-lg-start mb-5 mb-lg-0">
                                <h4 class="mb-0   default_font_family_c"><?php echo $args['page_templates']['thankyou_page']['promotions']['heading']; ?></h4>
                                <p class="py-4 mb-0 color_quaternary"><?php echo $args['page_templates']['thankyou_page']['promotions']['content']; ?></p>
                                <a href="<?php echo get_home_url() . $args['page_templates']['thankyou_page']['promotions']['button_link']; ?>" class="btn btn-secondary mw-250"><?php echo $args['page_templates']['thankyou_page']['promotions']['button_text'] ?></a>
                            </div>
                                    <!-- Coupon starts -->
                            <?php
                            if ($get_rds_template_data_array['globals']['promotion']['variation']) {
                                get_template_part('global-templates/promotion/thank-you/a' , null, $get_rds_template_data_array);
                            }
                            ?>
                                  <!-- Coupon ends -->
                        </div>
