...
class RDS_Service_Area_Widget extends Widget_Base {
    ...
    protected function render() {
        ...
        $args['globals']['service_area']['subheading'] = sanitize_text_field($settings['subheading']);
        $args['globals']['service_area']['heading'] = sanitize_text_field($settings['heading']);
        ...
        $args['globals']['service_area']['first_tab_heading'] = sanitize_text_field($settings['first_tab_heading']);
        $args['globals']['service_area']['second_tab_heading'] = sanitize_text_field($settings['second_tab_heading']);
        $args['globals']['service_area']['third_tab_heading'] = sanitize_text_field($settings['third_tab_heading']);
        $args['globals']['service_area']['fourth_tab_heading'] = sanitize_text_field($settings['fourth_tab_heading']);

        $args['globals']['service_area']['first_tab_description_html_allowed'] = sanitize_text_field($settings['first_tab_description_html_allowed']);
        $args['globals']['service_area']['second_tab_description_html_allowed'] = sanitize_text_field($settings['second_tab_description_html_allowed']);
        $args['globals']['service_area']['third_tab_description_html_allowed'] = sanitize_text_field($settings['third_tab_description_html_allowed']);
        $args['globals']['service_area']['fourth_tab_description_html_allowed'] = sanitize_text_field($settings['fourth_tab_description_html_allowed']);
