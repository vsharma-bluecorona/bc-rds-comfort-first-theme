    ...
    <div class="card border-0 rounded-0 p-0 position-relative blogs h-100">
        <a href="<?php echo get_permalink(); ?>" name="<?php echo get_the_title(); ?>" class="no_hover_underline no-underline">            
            ...
            <div class="card-body px-0 py-0">
                <h3 class="mb-0 pb-3 color_quaternary_c text_bold"><?php echo get_the_title(); ?></h3>
                <p class="color_quaternary_c">
                    <?php
                ...
                <span class="no_hover_underline w-100 d-inline-flex align-items-center   mb-3 position-absolute lessthenfour blog_read_more_text_color" style="bottom: -40px">
                    <span class="continue blog_read_more_text_color text-uppercase text_14 line_height_40 text_heavy default_font_family_c"> Keep Reading</span> <i class="bc_line_height_18 icon-chevron-right2 ms-1 position-relative "></i>
                </span>
            </div>
        </a>
    </div>
...
<div class="col-lg-4 col-md-12 mb-4 pb-2 pt-4">
                                            <div class="card border-0 rounded-0 p-4 position-relative blogs h-100 shadow">
                                                <a href="<?php echo get_permalink(); ?>" class="no_hover_underline no-underline">
                                                    ...
                                                    <div class="card-body px-0 py-0">
                                                        <h3 class="mb-0 pb-3 color_quaternary_c"><?php echo get_the_title(); ?></h3>
                                                        <p class="color_quaternary_c">
                                                        <?php
                                                            $my_content = wp_strip_all_tags(get_the_excerpt());
                                                            echo wp_trim_words($my_content, 25);
                                                        ...
                                                        <span class="no_hover_underline w-100 d-inline-flex align-items-center text_semibold text-uppercase text_14 line_height_40 text_heavy default_font_family_c mb-3 blog_read_more_text_color"><span class="continue blog_read_more_text_color"> Keep Reading</span> <i class=" bc_text_18 bc_line_height_18 icon-chevron-right2 ms-1 position-relative "></i>
                                                        </span>
                                                    </div>
                                                </a>
                                            </div>
