<div class="row py-lg-2">
    ...
    <div class="col-lg-12 px-0">
        <img src="<?php echo $image_placeholder_image; ?>" srcset="<?php echo $image_placeholder_image; ?> 1x, <?php echo $image_placeholder_image2x; ?> 2x, <?php echo $image_placeholder_image3x; ?> 3x" class="img-fluid float-lg-start me-lg-5 pb-lg-0 pb-4 d-lg-inline-block d-none" width="540" height="534" alt="About Page Image">
        <img src="<?php echo $m_image_placeholder_image; ?>" srcset="<?php echo $m_image_placeholder_image; ?> 1x, <?php echo $m_image_placeholder_image2x; ?> 2x, <?php echo $m_image_placeholder_image3x; ?> 3x" class="img-fluid float-lg-start me-lg-5 pb-lg-0 pb-4 d-inline-block d-lg-none "  alt="About Page Image">
