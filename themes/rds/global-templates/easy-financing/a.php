<?php if(!$args['globals']['financing']['hidden']): ?>
    ...
    <div class="py-3">
        ...
        <span class=" p-alt text_22 font_default text_normal line_height_25_3 pb-lg-5 pb-4 d-block"><?php echo $args['globals']['financing']['subheading']; ?> </span>
        <a href="<?php echo get_home_url().$args['globals']['financing']['button_link']; ?>" class="btn btn-primary mw-177"><?php echo $args['globals']['financing']['button_text']; ?></a>
    </div>
    </div>
<?php endif; ?>