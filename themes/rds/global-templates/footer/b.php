...
?> 
<footer class=" overflow-hidden color_secondary_bg">
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-4 mx-auto text-center">
                    ...
                    <?php 
                                    ...
                                    ?>
                 <div class="text-center">
                 <a href="tel: <?php echo $args['site_info']['country_code']  . $args['site_info']['phone']; ?> ?>" class=" footer_phone_number position-relative mt-lg-4 mb-lg-4 d-inline-block me-lg-2"><?php echo $args['site_info']['country_code']  . $args['site_info']['phone']; ?></a>
                 </div>
    ...
    <div class=" footer_copyright_bar text-center text-lg-start  font_alt_1 mb-lg-0 mb-5 pt-1 pb-3 pt-lg-4 pb-lg-4">
        <div class="container py-lg-1 pb-3  p-alt  line_height_30   font_alt_1  text_normal  text_16 px-0  ">
            <i class="p-alt icon-copyright4   text_16  line_height_28  "></i> <?php echo date("Y"); ?> <?php echo $args['site_info']['copyright_title']; ?><?php if ($args['site_info']['bluecorona_branding'] == true) { ?><span class="d-none d-sm-inline-block  line_height_30  font_alt_1  text_normal  text_16 d-lg-inline-block">&nbsp;|&nbsp;</span><span class="d-block d-sm-inline-block d-lg-inline-block  p-alt ">Web Design by&nbsp;&nbsp;</span><?php } ?>
            <a class=" footer_copyright_links a-alt copyright_hover" target="_blank" href="<?php echo $args['site_info']['bluecorona_link']; ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/footer/bc-logo.svg" width="19" height="20" <?php echo $copyright_svg_alt; ?>>&nbsp;&nbsp;Blue Corona</a><span class="d-none d-sm-inline-block d-lg-inline-block d-none">&nbsp; | &nbsp;</span><a class=" footer_copyright_links  a-alt  copyright_hover"  href="#" data-bs-toggle="modal" data-bs-target="#disclaimer">Disclaimer</a><span class="d-inline-block">&nbsp; | &nbsp;</span><a class=" footer_copyright_links  a-alt copyright_hover" href="<?php echo get_home_url() . $args['site_info']['privacy_policy_link']; ?>">Privacy Policy</a>
        </div> 
    </div>
