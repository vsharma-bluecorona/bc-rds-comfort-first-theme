...
<div class="d-block order-lg-1 order-2">
    <div class="container-fluid px-lg-3 px-0">
        <div class="container">
            <div class="row pt-2">
                <div class="col-lg-7 mt-lg-n15-3 offset-lg-5 px-0 px-lg-3 ">
                    <div class="color_secondary_bg position-relative py-4 px-4 px-lg-0 ">
                        ...
                        <div class="ps-lg-5 pt-4 mt-lg-3 pb-lg-5 pb-2 mb-lg-0 mb-1 text-start">
                              ...
                              <?php $args['globals']['hero']['schedule_online']['type']; if ($args['globals']['hero']['schedule_online']['type'] != 'url' ) { ?>
