<div class="sidebar"><div class="shadow-lg d-lg-block d-none pt-lg-3 pb-lg-4 mt-lg-2   border_form bg_form order-lg-1 order-1">
    ...
    <span class="d-block pt-lg-1 text-center font_default text_normal text_26 line_height_31"><?php echo $args['page_templates']['subpage']['sidebar']['request_service']['heading']; ?></span>
