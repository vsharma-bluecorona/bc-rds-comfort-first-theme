                ...
                <div class="col-lg-11 mw-lg-1073 ms-lg-auto d-lg-flex align-items-center px-lg-0 px-0 ">
                    ...
                    <div class="d-lg-flex w-100 mw-lg-1073 py-lg-0 py-5  align-items-center financing-bg-c" >
                        ...
                        <div class="d-block ps-lg-4 pt-lg-0 pt-3">
                            ...
                            <<?= $subheading_tag ?> class="mt-2 mb-0 pb-1"><?php echo $args['page_templates']['service_subpage']['financing']['subheading']; ?></<?= $subheading_tag ?>>
                              <?php if(!empty($args['page_templates']['service_subpage']['financing']['button_text'])){ ?>
                            <a href="<?php echo get_home_url().$args['page_templates']['service_subpage']['financing']['button_link']; ?>" class="no_hover_underline text_18 text-uppercase line_height_23 d-inline-flex align-items-center justify-content-center font_alt_2 text_semibold"><?php echo $args['page_templates']['service_subpage']['financing']['button_text']; ?><i class="icon-chevron-right2 text_18 line_height_18 ms-2 position-relative"></i></a>
                              <?php } ?> 
                        </div>
                    </div>
                </div>
