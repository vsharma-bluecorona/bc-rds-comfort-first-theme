...
$get_alt_text = rds_alt_text();
        ...
        $phone_number = !empty($args['globals']['header']['phone_number']) ? $args['globals']['header']['phone_number'] : $args['site_info']['phone'];
                ...
                <div class="row my-4 py-3">
                    <div class="col-lg-3 col-sm-4 col-12 mr-0 align-self-center pe-0">
                        <a href="<?php echo get_home_url(); ?>" class="d-inline-block">
                            <img src="<?php echo get_exist_image_url('header','m-header-logo'); ?>"  srcset="<?php echo get_exist_image_url('header','m-header-logo'); ?> 1x, <?php echo get_exist_image_url('header','m-header-logo@2x'); ?> 2x, <?php echo get_exist_image_url('header','m-header-logo@3x'); ?> 3x" <?php echo $header_logo_alt; ?> class="branding_logo img-fluid w-auto" style="max-width: 260px; max-height: 130px;" width="294" height="59">
                        </a>
                    </div>
                    <div class="col-lg-9 ps-0 text-end ">
                        <div class="d-lg-flex align-items-center justify-content-end font_default mt-2">
                            ...
                            <?php echo $args['globals']['header']['call_text'] ?> <a href="tel: <?php echo $args['site_info']['country_code'] . $phone_number; ?>" class=" phone_number">
                                    <?php echo $args['site_info']['country_code'] . $phone_number; ?></a> 
                            </span>

                          <?php if ($args['globals']['desktop_schedule_online_button']['enabled']) : ?>
    <a class="btn btn-primary mw-242 mh-43 " href="<?php echo esc_url($args['globals']['desktop_schedule_online_button']['url']); ?>">
                ...
                <div class="row row-eq-height no-gutters align-items-center">
                    ...
                    <div class="col-9 text-left px-0 ps-4">
                        <a href="<?php echo get_home_url(); ?>" class="d-block">
                            <img width="200" height="40" class="w-auto img-fluid" style="max-width: 200px " src="<?php echo get_stylesheet_directory_uri(); ?>/img/header/m-header-logo.webp" srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/header/m-header-logo.webp 1x, <?php echo get_stylesheet_directory_uri(); ?>/img/header/m-header-logo@2x.webp 2x, <?php echo get_stylesheet_directory_uri(); ?>/img/header/m-header-logo@3x.webp 3x" <?php echo $header_mobile_logo_alt; ?>>
                        </a>
                    </div>
            ...
            <div class="modal-dialog mt-0" role="document">
                <div class="modal-content border-0 position-absolute mt-md-0">
                    ...
                    <div class="modal-body px-2 mobile_popup_form_background_color text-center border-0">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/header/m-menu-cta-logo" srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/header/m-menu-cta-logo 1x, <?php echo get_stylesheet_directory_uri(); ?>/img/header/m-menu-cta-logo@2x 2x, <?php echo get_stylesheet_directory_uri(); ?>/img/header/m-menu-cta-logo@3x 3x" class="mb-4 w-auto h-auto" <?php echo $header_mobile_cta_alt ?> width="191" height="39"> 
                        <div class="text-center">
                            <a href="tel:<?php echo $args['site_info']['country_code'] . $phone_number; ?>" class=" btn-quaternary">
                                <i class="icon-phone"></i> call | <?php echo $args['site_info']['country_code'] . $phone_number; ?> <i class="icon-chevron-right2"></i>
                            </a>
                            <?php
