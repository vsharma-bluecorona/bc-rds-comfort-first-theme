                                                        ...
                                                        <div class="<?php echo ($enable_sidebar === 'yes') ? 'col-lg-6 mb-lg-5 mb-4 pb-lg-3' : 'col-lg-4 mb-lg-5 mb-4'; ?>">
                                                            <div class="h-auto border-quaternary-dashed  p-lg-2 p-3">
                                                                <div class="coupon_name  color_primary_bg  h-100 py-4 p-4 px-lg-0 text-center" style="background-color: <?php echo $colorCode; ?>;">
                                                                    ...
                                                                    <span class="pt-lg-3 pt-2 d-block px-3 coupon_expiry"><?php if($noexpiry !=1){ echo 'Expires ' . $date;}?></span><span class="d-block coupon_disclaimer"><?php echo $footer_heading; ?></span>
                                                                </div>
                                                            </div>
                                                        </div>  
                                                        <?php 
