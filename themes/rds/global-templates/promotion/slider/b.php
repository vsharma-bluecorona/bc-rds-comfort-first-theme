                        ...
                        <div class="row mx-0">
                            <div class="homepage_coupon pt-lg-5 mt-4 pb-lg-4 px-lg-0 px-2 mx-lg-0 mx-1">   
                                ...
                                <div class="coupon_slider position-relative">
                                    <div class="swiper home-coupon-swiper-b home-coupon-swiper-b-<?= $widget_id; ?> d-lg-block d-none">
                                    ...
                                    <div class="swiper m-home-coupon-swiper-b-<?= $widget_id; ?> d-lg-none d-block">
                                    ...
                                    if (!empty($template) && basename($template) == 'rds-landing.php') {
                                        ?>
                                        <div class="swiper-button-next home_coupon_next_b-<?= $widget_id; ?>">
                                            <i class="icon-chevron-right text_25 true_black line_height_42   transform"></i>
                                        </div>
                                        <div class="swiper-button-prev home_coupon_prev_b-<?= $widget_id; ?>">
                                            <i class="icon-chevron-left text_25 true_black line_height_42   transform"></i>
                                        </div>
                                    <?php } else { ?>
                                        <div data-dark-color="color_primary"  class=" apply-conditional-color swiper-pagination home-coupon-pagination-b-<?= $widget_id; ?> pagination-variation-a position-relative d-lg-block d-none"></div>
                                        <div data-dark-color="color_primary"  class=" apply-conditional-color swiper-pagination pagination-variation-a m-home-coupon-pagination-b-<?= $widget_id; ?> position-relative d-lg-none d-block"></div>
