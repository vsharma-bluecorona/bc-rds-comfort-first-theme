    ...
    <div class="container px-0 pb-lg-2 pb-4">
        <div class="row py-2 pb-lg-3">
            <div class="col-lg-12 py-3 py-lg-4"> 
                ...
                if ($i == 0) {?>
                    <span class="d-block display1"><?php echo $args['page_templates']['landing_page']['banner']['heading'] ?> </span> 
                    <span class="d-block display2"><?php echo $args['page_templates']['landing_page']['banner']['subheading'] ?> </span>
                      <?php if(!empty($args['page_templates']['landing_page']['banner']['button_text'])){ ?>
                    <a href="<?php echo get_home_url().$args['page_templates']['landing_page']['banner']['button_link'] ?> " class="btn btn-primary mw-237  mt-3"><?php echo $args['page_templates']['landing_page']['banner']['button_text'] ?>  <i class="icon-chevron-right1 ms-1 text_18 line_height_18  d-lg-inline-block d-none"></i></a> 
                <?php   }
            }
                ?>
            </div>
