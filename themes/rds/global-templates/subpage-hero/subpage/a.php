        ...
        <div class="row py-2 pb-lg-3">
            <div class="col-lg-12 py-3 py-lg-4"> 
                ...
                if ($i == 0) {?>
                    ...
                    <a href="<?php echo get_home_url().$args['page_templates']['subpage']['banner']['button_link'] ?> " class="btn btn-primary mw-237  mt-3"><?php echo $args['page_templates']['subpage']['banner']['button_text'] ?>  <i class="icon-chevron-right1 ms-1 text_18 line_height_18  d-lg-inline-block"></i></a> 
                <?php   }
            }
                ?>
            </div>
