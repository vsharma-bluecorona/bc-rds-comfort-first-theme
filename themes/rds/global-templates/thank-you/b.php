        ...
        <div class="row pb-lg-2 mx-0 align-items-lg-center">
            <div class="col-lg-6 order-lg-1 order-2">
                <div class="mw-lg-540 ms-auto text-lg-start text-center">
                    ...
                    <?php  $temName = basename( get_page_template() );
                    if($temName != "rds-coupon-thankyou.php"){ ?>
                        <div class="pt-2">
                            <span onclick="scrollSmoothTo('thankyou_page_promotion')" class="btn btn-primary mw-338 next-service" id="bc-thankyou"><?php echo $args['page_templates']['thankyou_page']['scroll_button_text'] ?> <i class="icon-circle-arrow-down2 ms-2 line_height_18 top_n1"></i></span>
                        </div>
                    <?php } ?>
                </div>
            </div>
            <div class="col-lg-6 text-start order-lg-2 order-1  pe-lg-0 px-0 ">
                <img src="<?php echo get_exist_image_url('thank-you','thank-you-graphic-b'); ?>" srcset="<?php echo get_exist_image_url('thank-you','thank-you-graphic-b'); ?> 1x, <?php echo get_exist_image_url('thank-you','thank-you-graphic-b@2x'); ?> 2x, <?php echo get_exist_image_url('thank-you','thank-you-graphic-b@3x'); ?> 3x" class="img-fluid mx-auto w-100" alt="Thank You Image" width="945" height="600">
            </div>
        </div>
    </div>
