...
class RDS_Seo_Widget extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('RDS SEO Widget', 'rds-template-seo-widget');
    }
    ...
    protected function register_controls() {        
        $this->start_controls_section(
                'rds_seo_widget',
                [
                    'label' => esc_html__('Seo Template Widget', 'rds-seo-widget'),
                ]
        );
        ...
        if ($this->variationIsset) {
            ...
            foreach ($this->allVariation as $key => $value) {
                $options[$key] = esc_html__($value, 'rds-template-seo-widget');
            }
            $this->add_control(
                'seo_variation',
                     array(
                        'label' => esc_html__('Variation', 'rds-template-seo-widget'),
