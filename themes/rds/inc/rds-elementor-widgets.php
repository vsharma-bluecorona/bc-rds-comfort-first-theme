...
function register_rds_elemetor_widgets($widgets_manager) {
   ...
   $widgets_manager->register(new \RDS_Accordion_Widget());
    ...
    require_once( __DIR__ . '/elementor-widgets/RDS_Discover_The_Difference_Widget.php' );
   ...
   // $widgets_manager->register(new \RDS_Footer_Widget());
    ...
    require_once( __DIR__ . '/elementor-widgets/RDS_Career_Employee_Of_The_Month_Widget.php' );
    ...
    require_once( __DIR__ . '/elementor-widgets/RDS_Service_Subpage_Banner_Widget.php' );
    ...
    $widgets_manager->register(new \RDS_Subpagesidebar_Widget());
     ...
     require_once( __DIR__ . '/elementor-widgets/RDS_Subpagesidebar_Request_Widget.php' );

    $widgets_manager->register(new \RDS_Subpagesidebar_Request_Widget());

    require_once( __DIR__ . '/elementor-widgets/RDS_Subpagesidebar_Promotion_Widget.php' );

    $widgets_manager->register(new \RDS_Subpagesidebar_Promotion_Widget());

    require_once( __DIR__ . '/elementor-widgets/RDS_Subpagesidebar_Financing_Widget.php' );

    $widgets_manager->register(new \RDS_Subpagesidebar_Financing_Widget());

    require_once( __DIR__ . '/elementor-widgets/RDS_Service_Subpagesidebar_Request_Widget.php' );

    $widgets_manager->register(new \RDS_Service_Subpagesidebar_Request_Widget());

    require_once( __DIR__ . '/elementor-widgets/RDS_Service_Subpagesidebar_Services_Widget.php' );

    $widgets_manager->register(new \RDS_Service_Subpagesidebar_Services_Widget());

    require_once( __DIR__ . '/elementor-widgets/RDS_Service_Subpagesidebar_Financing_Widget.php' );
    ...
    $widgets_manager->register(new \RDS_Promotion_Template());
     ...
     require_once( __DIR__ . '/elementor-widgets/RDS_About_Middle_Content_Widget.php' );

    $widgets_manager->register(new \RDS_About_Middle_Content_Widget());

    require_once( __DIR__ . '/elementor-widgets/RDS_About_Meet_The_Team_Widget.php' );
    ...
    require_once( __DIR__ . '/elementor-widgets/RDS_Financing_Content_Widget.php' );

    $widgets_manager->register(new \RDS_Financing_Content_Widget());

    require_once( __DIR__ . '/elementor-widgets/RDS_Financing_Affiliation_Widget.php' );
    ...
    require_once( __DIR__ . '/elementor-widgets/RDS_Financing_Company_Service_Widget.php' );

    $widgets_manager->register(new \RDS_Financing_Company_Service_Widget());

     require_once( __DIR__ . '/elementor-widgets/RDS_Financing_Middle_Content_Widget.php' );
    ...
    require_once( __DIR__ . '/elementor-widgets/RDS_Landing_Page_Banner_Widget.php' );

    $widgets_manager->register(new \RDS_Landing_Page_Banner_Widget());

    require_once( __DIR__ . '/elementor-widgets/RDS_History_Middle_Content_Widget.php' );
    ...
    require_once( __DIR__ . '/elementor-widgets/RDS_History_Tab_Section_Widget.php' );
