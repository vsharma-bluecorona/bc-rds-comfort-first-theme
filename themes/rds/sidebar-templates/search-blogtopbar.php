        ...
        <div class="col-lg-4 my-3 col-md-4 col-12 pe-lg-3">
            <div class="input-group">
                <div class="input-group-prepend">
                    <button id="searchsubmit" aria-label="Center Align" type="submit" class="input-group-text color_secondary_bg color_tertiary_hover_bg border-0 rounded-0 h-54 text-center w-54  cursor-pointer"><i class="icon-magnifying-glass2 true_white bc_text_18 bc_line_height_18 mx-auto"></i></button>
                </div>
                <input type="text" id="search" value="<?php echo get_search_query(); ?>" name="s" class="form-control blog-search rounded-0 border-0 alt-color2-bg font_alt_1 text_normal text_16 line_height_30 h-54" placeholder="SEARCH">
            </div>
        </div>
        ...
        <div class="col-lg-4 my-3 col-md-4 col-12 ps-lg-2 pe-lg-3">
            <div class="input-group">
                ...
                <div class="custom-select">
                    <select name="cat" id="inputGroupSelect01" class="form-control rounded-0 blog-select" onchange="document.location.href = this.options[this.selectedIndex].value;">
